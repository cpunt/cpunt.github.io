...
layout: post
title: Linked Lists
meta: This article will cover a Linked List. It will include a breakdown of the data structure, why use it, and code examples of a Linked List.
posted: 20/08/2020
source: ''
category: Article
...
## Summary
Linked Lists can be a powerful data structure when used in the correct circumstances. Click [here](https://github.com/cpunt/articles-code-examples/blob/master/linked-lists/main.py) to view the code examples in this article. If you want to do some interview preparation on Linked Lists, [hackerrank](https://www.hackerrank.com/domains/data-structures?filters%5Bsubdomains%5D%5B%5D=linked-lists) and [leetcode](https://leetcode.com/tag/linked-list/) have some good questions. 
